...
$CFG->dbname    = 'bitnami_moodle';     // database name, eg moodle
$CFG->dbuser    = 'bn_moodle';   // your database username
$CFG->dbpass    = '490bfd51e7';   // your database password
...
$CFG->dboptions = array(
    'dbpersist' => false,       // should persistent database connections be
                                ...
                                //  sometimes
    'dbsocket'  => '@@BITROCK_DB_SOCKET@@',       // should connection via UNIX socket be used?
...
//
$CFG->passwordsaltmain = '@@BITROCK_SALT@@';
//
...
//
     $CFG->lang = '@@BITROCK_LANGUAGE@@'; // for example 'cs'
//
